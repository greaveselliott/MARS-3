...
**Current release readiness:** Not releasable; H-001-E6 received QA changes-requested
...
| --- | --- | --- | --- | --- |
| F-001-S1 authority route | doctrine-foundation | foundation | exact ordered-chain enforcement and corrected signed claim pass locally | E6 changes-requested; replacement evidence pending |
