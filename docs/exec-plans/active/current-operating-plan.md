...
`W-001-delivery` grant now authorizes the Work Authority Engineer's bounded
...
principal, and paths; no lease exists yet.
...
- Postclaim reconciliation: QA and Security accepted v6 tree
  ...
  read-back.
- Delivery authority: signed grant `W-001-delivery`, attempt
